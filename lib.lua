...
local drawing  = loadstring(game:HttpGet('https://raw.githubusercontent.com/ghastlytim/modules/refs/heads/main/libdraw.lua'))()
local tween = loadstring(game:HttpGet('https://raw.githubusercontent.com/ghastlytim/modules/refs/heads/main/libtween.lua'))()
