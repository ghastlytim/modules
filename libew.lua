...
local library = utility.table({theme = table.clone(themes.Default), folder = "vozoiduilib", extension = "vozoid", flags = {}, open = true, keybind = Enum.KeyCode.End, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
        ...
        function tabtypes:Section(options)
            ...
            function sectiontypes:Toggle(options)
                ...
                icon.MouseEnter:Connect(function()
                    if tooltip then
                        local tooltipbox = utility.create("Square", {
                            Filled = true,
                            Thickness = 0,
                            Theme = "Object Background",
                            Size = UDim2.new(0, 10, 0, 10),
                        ...
                        utility.outline(tooltipbox, "Object Border")
                        ...
                        spawn(function()
                            ...
                            local tween = tweenService:Create(tooltipbox, tweenInfo, {Transparency = 1})
                            tween:Play()
